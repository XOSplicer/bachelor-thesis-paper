...
The movement of passengers can be described with three directions: \emph{incoming}, \emph{outgoing}, and \emph{inter-floor} traffic. %\autocite[][p.~259]{siikonen1993simulation}. 
With those directions the traffic patterns can be described, as they focus on one of the directions, but also incorporate passengers heading in other directions \autocite[][p.~259]{siikonen1993simulation}.
...
\begin{itemize}
    \item \textbf{Up-peak traffic} In the morning the majority of passengers constitutes to an incoming traffic.
    They arrive at the entrance lobby and travel to different upper floors to fill the building.
    \item \textbf{Down-peak traffic} In the evening the majority of the passengers are leaving the building and travel from arbitrary upper floors to the main lobby.
...
Figure \ref{fig:sota:trafficpatterns} depicts the former mentioned traffic directions.
