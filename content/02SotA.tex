...
and $V$ is the domain of the properties of the real world represented by this point.
Typical examples for $ D $ are two dimensional images where the points are of the form $ (x, y) $, three dimensional images with points of the form $ (x, y, z) $ or videos with points of the form $ (x, y, t) $ where $ t $ is the time dimension.
...
In order to store such an image on a computer a \emph{matrix representation} from the can be chosen.
For two dimensional images this matrix is element of $ D^{X \times Y} $
