...
\textcite[][pp.~141--158]{unger2015aufzuege} describes the properties of th

\begin{itemize}
    \item Cabis that carry \textbf{only people} typically have 
    \item \textbf{Large goods and people}
    \item \textbf{Only small goods}
    \item \textbf{Only large goods}
\end{itemize}
