...
they press a button on the \emph{floor call panel} and issue a \emph{hall call} to the system.
...
\begin{figure}[hbt]
	...
	\caption{\label{fig:sota:traffictimes} General components of an elevator control system. Based on and adapted from \autocite[][pp.~4,16]{xang2016trafficlist} and \autocite[][pp.~6,10]{siikonen1997models}}
\end{figure}
