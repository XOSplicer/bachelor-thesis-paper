...
This is the \enquote{most common form of automatic control} \autocite[][p.~23z]{barney2016handbook}.
Hall calls are answered in the order of the floors they originate from rather than their 

"most common type of control"

\paragraph{Zone Approach}

\paragraph{Search-Based Approach}
