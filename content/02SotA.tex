...
some are perceived as part of the service quality by the passengers.
...
\begin{itemize}
    ...
    \item The number of \textbf{total stops}
        necessary to serve an specified amount of passengers (or within an given time frame) is an indicator for the efficiency of the scheduling algorithm.
        \autocite[][p.~194]{unger2015aufzuege}
