...
Since the field has a broad range of applications and is influenced by various subjects such as methematics, physics and computer science, \textcite{zhang2017imageprocessing} coins the term of \emph{image engineering} to isolate the
...
\emph{Image processing} deals with the \quote{manipulation of an image to produce another (improved) image} \autocite[][]{zhang2017imagereocessing}. 
...
This data can the be used to make decisions about the objects in the image.
