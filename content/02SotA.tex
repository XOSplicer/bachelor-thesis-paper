...
Typically there are is one zone per elevator. 
...
The static zone approach can be extended to a dynamic sector approach where the sectors are not limited by static floor numbers but by the positon of 

\autocite[][p.~250]{barney2016handbook}
