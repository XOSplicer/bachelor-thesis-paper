...
OpenCV (Open Computer Vision Library) is a free and open-source library,
which collects many common functionalities for advanced computer vision.
It is written in C/C++ and offers \ac{API} bindings for C++, Python and Java on  \autocite[][]{opencv2018opencv}
...
Since video images can contain pixel level noise, it is useful convert color video to grey-scale and to blur the images before applying the background substraction.
