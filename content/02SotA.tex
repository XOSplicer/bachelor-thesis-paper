...
\begin{itemize}
    ...
    \item \textbf{Handling capacity}, also called \enph{5-minute interval}\autocite[][p.~194]{unger2015aufzuege}, describes the number that can be transported at maximum into the upper most floor during up-peak traffic. TODO - handling capacity = 5min in uppeak \autocite[][pp.8-9]{siikonen1997models} 60-80\%, depends on rtt
