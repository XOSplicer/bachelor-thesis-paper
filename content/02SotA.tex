...
For each of the metrics it is common to calculate statistical figures, such as average, mean, minimum, maximum, 
These calculations can be based on theoretical consideration \autocite[][p.~194]{unger2015aufzuege}, 
