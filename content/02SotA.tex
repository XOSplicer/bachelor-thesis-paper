...
\begin{figure}[hbt]
	...
	\caption{\label{fig:sota:systemcomponents} General components of an elevator control system. Based on and adapted from \textcite[][pp.~4,16]{xang2016trafficlist} and \textcite[][pp.~6,10]{siikonen1997models}}
\end{figure}
...
and capture information about the direction or destination of travel.
...
In a multi-elevator system the hall call is registered by the \emph{group controller} and stays active until it is deleted when an elevator serves it by picking up the passenger.
In case of a single-elevator system no group controller is necessa


TODO
drive system: - shaft and movement mechanism  motors -- motor control (cabin dispatch)
