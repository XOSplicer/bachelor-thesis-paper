...
To apply the kernel $ K $ to the image $ F $, they are convoluted.
...
\autocite[][]{opencv2018kernel}


Can be used to find local features such as edges, or to blur or sharpen the image
