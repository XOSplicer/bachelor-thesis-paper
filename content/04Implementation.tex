...
\begin{enumerate}
    ...
    \item For each traffic patterns, run the simulation with the tree different scheduling 
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Update the  metrics about waiting and ride time for each traffic item that is currently in the floor queues or in the elevator.
