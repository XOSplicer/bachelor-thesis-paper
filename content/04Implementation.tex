...
data transparency, purpose limitation, data minimization, storage limitation and confidentiality
\autocite{ico2018gdpr}.

The presented visual system has a limited purpose, in that it is only used 
...
In order to keep the video data confidential, 
measures must be taken to prevent access by unauthorized parties.
Since the purpose of the system does not pose the necessity to make to process or access the video data outside of the system, there  
