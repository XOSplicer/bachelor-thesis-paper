...
These principles of data transparency, purpose limitation, data minimization, storage limitation, confidentiality are also visible in the European \ac{GDPR} \autocite{eu2016gdpr}.

purpose limitation -> faster lift service
data transparency -> must have a sign in / infront of the elevator
data minimization -> only as few cameras as necessary, only necessary resolution
