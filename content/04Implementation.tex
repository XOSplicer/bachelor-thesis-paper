...
if publically accesible \autocite[][§~4]{bmjv2009bdsg} -> only allowed for specified purposes, must be deleted wehn no longer needed for this purpose, passengers must be informed about presence of survialience cameras and the processing system.
\enqoute{Appropriate measures shall be taken to make the surveillance and the controller’s name and contact details identifiable as early as possible.}
