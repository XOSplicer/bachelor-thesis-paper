...
\begin{itemize}
    \item \textbf{Hospitals} with elevators where patient beds are moved. The medical beds are usually as large as the elevator allows and therefore block the elevator from being used by groups of additional passengers. Additionaly patients with meduical conditions  
    \item Large office buildings with \textbf{auxiliary lifts}
    \item \textbf{Warehouses} or \textbf{fabrication plants} 
\end{itemize}
