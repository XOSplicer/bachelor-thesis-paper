...
Therefore delivering them faster causes a shorter block of theses resources, resulting in a better overall utilization.

The precondition of applying the adaptive control strategy is the knowledge, whether a cargo objects is currently inside the elevator cabin and is blocking it for other passengers 
and the information about the destination of this object.


how to achive precondition: visual system with destination assosiation, alternative: override button
when to use: 

this shows, when in a buidling with susch and such traffic conditions, utilizing this concept can be beneficial
