...
Rust is not a pure object oriented language, but rather a imperative system programming language, which solves generic programming via interfaces.
...
All of them can be found in the rust package repository \url{}
\begin{itemize}[noitemsep]
