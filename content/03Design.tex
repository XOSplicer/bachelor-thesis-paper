...
Cameras inside the cabin can determine, if passengers are currently occupying the space in it and if additional large cargo objects are inside.
...
\ref{fig:design:systemintegration}
