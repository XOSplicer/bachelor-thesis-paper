...
With the aid of the previously generated measurements, each blob can be classified.
Blobs with a volume smaller than a specific threshold are probably erroneous artifacts and can easily ignored.
