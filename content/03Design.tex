...
To design this system, the approach described in the previous section is followed.
First the integration into an typical elevator system is described, 
than the detection capabilities of the system are specified.
