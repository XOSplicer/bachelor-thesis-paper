...
\textbf{Non-directional Collective Control}:
\begin{enumerate}[noitemsep]
...
Table \ref{tab:design:trafficitemprototypes} describes the 

define what unbiased floor bias is

$$ b(f_1, f_2) =
    \begin{cases} 
      \frac{1}{n} & f_1 \neq f_2, f_1,f_2 \in \mathbb{N}_{\gt 0} \\
      0 & else
   \end{cases}
$$
