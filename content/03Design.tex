...
are read into the memory of the system as color images 
with native resolution of the cameras.
To decrease the computation power needed for the next steps, it is possible to scale them down to a smaller 
