...
(persons and caro)
    ...
    - transfer time into/outof car
    - arival rates for floors
    - floor bias
simulation parameters:
    - simualtion period
    - time slices (tick rate)
...
\begin{table}[]
\begin{tabular}{lrl}
\textbf{Description}    & \multicolumn{1}{l}{\textbf{Value}}   & \textbf{Unit}   \\
\hline
...
Flight time single floor & 5 & $s$\\
%& & \\
\hline
\multicolumn{3}{l}{\textbf{Passenger Data}}\\
Arrival rates for floors & & $s \rightarrow s^{-1}$\\
...
Arrival rates for floors & & $s \rightarrow s^{-1}$\\
Weight distribution & & $kg \rightarrow \mathbb{R}$\\
Space need distribution & & $m \times m \times m \rightarrow \mathbb{R}$\\
Transfer time into / out of car & 5 & $s$\\
Floor bias & unbiased &  \\
%& & \\
\hline
\multicolumn{3}{l}{\textbf{Simulation Parameters}}\\
Simulation Period & 3600 & $s$\\
Time slice & 0.1 & $s$\\
