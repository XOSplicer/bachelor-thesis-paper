...
\begin{itemize}
    ...
    \item The distorti
    \item An additional scaling factor $ w $, which is later used to convert from real life room coordinates to unit coordinates in the range of $ [-1;+1] $.
\end{itemize}
The parameters are used in the next step, to guide the volume reconstruction.
