...
For the test of the visual system an exemplary office elevator is used.
Inside it, multiple cameras are mounted all viewing the center of the cabin.

The cameras do not capture a live stream that is processed but record a video for later processing. T
