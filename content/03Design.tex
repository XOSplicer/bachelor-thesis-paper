...
First the whole volume of the elevator is described as a \ac{3D} image of $ X \times Y \times Z $ voxels.
...
the position of every voxel is projected into the viewport of each camera by applying the formula given in figure \ref{fig:sota:camcalib} to it with the parameters obtained from the came
