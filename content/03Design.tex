...
The technique to generate the data that is 

TODO intro 
and \ref{fig:design:volumedetection} 
and short explain of figure 
and left is extern input, right is internal processing
and describe what nexts paragraphs will do
