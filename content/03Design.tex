...
TODO
consider translation, rotation and internal matrix, as well as distortion
...
The following parameters must be obtained, which are also explained in figure \ref{fig:sota:camerprojection}:
\begin{itemize}
    \item The internal camera matrix $ $, which includes the 
\end{itemize}
The parameters are used in the next stept, to guide the volume reconstruction.
...
TODO describe howthe prototypes are used 
