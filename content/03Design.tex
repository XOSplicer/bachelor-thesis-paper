...
- imaginable real world scenarios: hospital where also patient beds are moved (which should have an empty elevator and be prioritized) OR mutlistory storage buildings where  OR
