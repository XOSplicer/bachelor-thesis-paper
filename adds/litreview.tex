...
\begin{itemize}
    \footnotesize
    \item Installing and configuring OpenCV
    \item Data types and structures
    \item Image types
    \item Manipulating pixels
    \item Scaling and rotating images
    \item Using video inputs
    \item Creating custom interfaces
    \item Thresholding
    \item Object detection
    \item Face and feature detection
