...
Early work that uses a single camera setup to measure the volume of baked goods. Used formula is $V  (\pi/4) \times A^2/h$, where area and height are contructed from pixel area and height w
